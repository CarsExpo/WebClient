  ...
  return (
    <div className='inscription'>
      <form onSubmit={handleSubmit} autoComplete="off">
        ...
        <div className="form__group field">
          <input type="input" className="form__field" placeholder="Métier" value={work} onChange={e => setWork(e.target.value)} required />
          <label htmlFor="work" className="form__label">Métier en RP</label>
        </div>
        <div className="form__group field">
